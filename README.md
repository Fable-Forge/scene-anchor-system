...
```text
帮我安装 scene-anchor-system：https://raw.githubusercontent.com/Fable-Forge/scene-anchor-system/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[scene-anchor-system Issues](https://github.com/Fable-Forge/scene-anchor-system/issues)
