...
```text
安装 scene-anchor-system：https://raw.githubusercontent.com/Fable-Forge/scene-anchor-system/main/docs/install.md
```
...
从 `https://github.com/Fable-Forge/scene-anchor-system` 安装 `scene-anchor-system`，验证目标目录和 `SKILL.md`，并诚实报告哪些 Agent 已可发现。
...
| 运行时 | 目标目录 |
|---|---|
| Codex | `~/.codex/skills/scene-anchor-system/` |
| Claude Code | `~/.claude/skills/scene-anchor-system/` |
| Agent Skills | `~/.agents/skills/scene-anchor-system/` |
